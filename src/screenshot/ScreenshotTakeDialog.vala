		...
		*/
		...
		public ScreenshotTakeDialog() {
			...
			*/
			...
			Object(title: "Take a screenshot");
			...
			/* Radio buttons */
			this.full = new Gtk.RadioButton.with_label_from_widget(null, "Full screen");
			this.active_window = new Gtk.RadioButton.with_label_from_widget(full, "Active window");
			this.selection = new Gtk.RadioButton.with_label_from_widget(full, "Selection");
